...
export default function Footer() {
    ...
    return (
        <div>
            <footer className="pa4 pa5-l black-70 bt b--black-10 garamond">
                <div className="mb4-l cf">
                    <h1 className="fl w-100 pv0 f6 fw6 ttu tracked mb4">Our Office</h1>
                    <article className="fl w-50 dib-ns w-auto-ns mr4-m mr5-l mb4 pr2 pr0-ns">
                        <h4 className="f5 f4-l fw6">Berkshire Hathaway</h4>
                        <span className="f7 f6-l db black-70">3555 Farnam Street</span>
                        <span className="f7 f6-l black-70">Omaha, NE 68131</span>
                        <a className="f6 db fw6 pv3 black-70 link dim" title="Call SF" href="tel:+1234567890">
                            +1 123-456-7890
                        </a>
                    </article>
                    <article className="fl w-50 dib-ns w-auto-ns mr4-m mr5-l mb4 pl2 pl0-ns">
                        <h4 className="f5 f4-l fw6">A Message About Geico:</h4>
                        <span className="f7 f6-l db black-70">
                        For a free car insurance rate quote that could save you substantial money, visit
                        </span>
                        <span className="f7 f6-l di black-70">
                        www.geico.com or call below, 24 hours a day.
                        </span>
                ...
                <a className="black-70 f1 f2-ns fw6 tl link dim dib pv3 mt2 mb4 mb0-l" href="https://www.berkshirehathaway.com/disclaimer.html" >
                    Legal Disclaimer
                </a>
                <div className="dt dt--fixed w-100" >
                    <div className="dn dtc-ns v-mid">
                    <p className="f7 black-70 dib pr3 mb3">
                        Copyright © Berkshire Hathaway 1978-{(new Date().getFullYear())}
                    </p>
                    </div>
